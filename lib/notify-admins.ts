...
export async function sendAdminClaimUpdate(
  ...
  try {
    // No quiet window — every helper claim/unclaim sends admins the
    // full update email regardless of day or time. Same shape every day:
    // headline + full week summary + Liezel WhatsApp forward button.
