...
export default async function PickupsPage({ searchParams }: { searchParams: { v?: string; d?: string } }) {
  ...
  return (
    <div className="space-y-3">
      <header className="px-1">
        <h1 className="font-display text-3xl sm:text-4xl">This week's pickups</h1>
        <p className="text-ink-700/70 text-sm sm:text-base mt-0.5">
          Everything on the family schedule. Tap any card to see details and claim it.
        </p>
      </header>
