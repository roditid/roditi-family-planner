 ...
 * containing the helper's personal sign-in link. wa.me handles the universal
 * routing so we don't need to fingerprint the user's platform.
 */
export default function WhatsAppButton({
  ...
  const message = [
    ...
    link,
    ``,
    `(Bookmark it — same link every week. On iPhone you can tap Share → Add to Home Screen for a one-tap icon.)`,
  ].join('\n');
